    ...
    def scan(self) -> List[Dict]:
        ...
        if schema:
            ...
            self.reporter.print_info(
                f"Schema contains {complexity['total_types']} types, "
            ...
            if sensitive_fields:
                self.reporter.print_warning(
                    f"Found {len(sensitive_fields)} fields with potentially sensitive names"
                )
                ...
                findings.append(
                    create_finding(
                        ...
                        evidence={"sensitive_fields": sensitive_fields[:10]},
            ...
            if deprecated:
                ...
                findings.append(
                    create_finding(
                        ...
                        evidence={"deprecated_fields": deprecated[:10]},
            ...
            if fields_with_args:
                self.reporter.print_info(
                    f"Found {len(fields_with_args)} fields accepting arguments"
                )
            ...
            if complexity["has_subscriptions"]:
                ...
                findings.append(
                    create_finding(
                        ...
                        evidence={"subscription_count": sub_count},
